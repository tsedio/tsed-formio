...
import * as FormEditStories from '../packages/react-formio/src/organisms/form/builder/FormEdit.stories'

<Meta title="Documentation/Form Edit"/>
...
<Canvas of={FormEditStories.EditWebForm} />
