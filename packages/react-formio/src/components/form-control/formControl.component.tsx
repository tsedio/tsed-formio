      ...
      <div className={"input-group"}>
        {prefix && (
          <div className='input-group-prepend'>
            <span className='input-group-text' data-testid="form-control-prefix" >{prefix}</span>
          </div>
        )}
        {children}
        {suffix && (
          <div className='input-group-append'>
            <span className='input-group-text' data-testid="form-control-suffix" >{suffix}</span>
          </div>
        )}
      </div>
      {description && <div data-testid="form-control-description" className='form-text text-muted'>{description}</div>}
    </div>
  );
}
