...
const useBaseConfiguration = ({ baseUrl, projectUrl }: BaseConfigurationArgs) => {
...
export function FormioProvider({ children, baseUrl, projectUrl }: { children: React.ReactNode } & BaseConfigurationArgs) {
  const formio = {
