...
import { FormAction } from "@tsed/react-formio/organisms/form/actions/FormAction";
...
export function FormActionComponent(props: ReturnType<typeof useAction>) {
  const { formAction, actionAction, form, action, actionInfo, gotoEdit, gotoRemove, removeAction, saveAction, i18n = (f) => f } = props;

  const RemoveModalComponent = props.RemoveModalComponent || RemoveModal;

  const removeRef: any = useTooltip({
    trigger: "hover",
    placement: "top",
    title: i18n("Remove")
  });
