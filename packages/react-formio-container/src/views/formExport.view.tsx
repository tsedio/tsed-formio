            ...
            label={
              (
                <span className={"flex items-center"}>
                  <i
                    className={iconClass(undefined, "detail") + " mr-1 text-secondary"}/> {i18n(`Export ${formType} schema`)}
                </span>
              ) as any
            }
          >
          ...
          <Card
            label={
              (
                <span className={"flex items-center"}>
                  <i
                    className={iconClass(undefined, "data") + " mr-1 text-secondary"}/> {i18n(`Export ${formType} submissions`)}
                </span>
              ) as any
            }
          >
